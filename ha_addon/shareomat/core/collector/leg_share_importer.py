# -*- coding: utf-8 -*-
"""
File: shareomat/core/leg_share_importer.py
...
Purpose:
    ...
    network location (e.g. /share/shareomat) without direct inbox access.
...
class ShareImporterThread(threading.Thread):
    ...
    def __init__(self, share_path: Path, inbox_path: Path, interval: int = 60) -> None:
        super().__init__(name="shareomat-share-importer", daemon=True)
